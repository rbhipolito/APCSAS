<?php
define('GLOBAL_PROJECT_NAME', 'Asia Pacific College Student Assistant System');
define('GLOBAL_SESSION_NAME', 'C992c1ab5');

//Default database settings
define('DEFAULT_DB_HOST','localhost');
define('DEFAULT_DB_USER','root');
define('DEFAULT_DB_PASS','');
define('DEFAULT_DB_USE' ,'mydb');

//Paths and directory names
define('BASE_DIRECTORY', 'sasystem');
